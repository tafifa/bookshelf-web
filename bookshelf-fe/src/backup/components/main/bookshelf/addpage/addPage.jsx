...
export default function AddPage() {
  ...
  return (
    <div className="bg-white">
      <h1 className="text-left font-semibold text-[32px] ml-20 ">Add Book</h1>
      <div
        id="form-field"
        ...
        <div className="w-[90%] h-[628px] bg-white border rounded-lg border-custom-grey-lighter flex flex-row gap-8 items-center justify-center ">
          <div className="h-[95%] w-[45%] bg-white flex flex-col text-left justify-between ">
            <div className="w-full flex flex-col gap-2 ">
              ...
              <div className="w-full h-[44px] bg-white border-custom-grey-lighter border rounded-xl flex items-center">
                <input
                  type="text"
                  className="ml-3 w-full bg-transparent outline-none  placeholder:text-custom-grey-light text-custom-grey-light "
            ...
            <div className="w-full flex flex-col gap-2 ">
              ...
              <div className="flex flex-row gap-2">
                {tags.map((tag, index) => (
                  <div
                    className="flex flex-row bg-custom-grey-lighter h-[24px] rounded-md items-center"
                    key={index}
                  >
                    <h5 className="ml-1 mr-1 text-white font-medium text-sm ">
                      {tag}
                    </h5>
                    <RxCross1
                      onClick={() => handleRemoveTag(index)}
                      className="cursor-pointer w-[15px] mr-1 "
                    />
                  </div>
                ))}{" "}
              </div>
          ...
          <div className="h-[95%] w-[45%]  flex flex-col justify-between text-left ">
            <div className="flex flex-col gap-4 ">
              <div className="w-full flex flex-col gap-2 ">
                ...
                <div className="w-full h-[110px] bg-white border-custom-grey-lighter border rounded-xl ">
                  <input
                    type="text"
                    className="ml-3 mt-3 w-full bg-transparent outline-none  placeholder:text-custom-grey-light text-custom-grey-light "
                    placeholder="input book description here"
                    name="description"
                    onChange={handleInputChange}
                  />
                </div>
            ...
            <div className="flex flex-row justify-end gap-5">
              <Link
                to="/"
                className="w-[102px] h-[34px] bg-custom-grey-light rounded flex justify-center items-center font-semibold text-xs text-white "
              >
                Cancel
              </Link>
              <button
                className="w-[102px] h-[34px] bg-custom-brown rounded flex justify-center items-center font-semibold text-xs text-white cursor-pointer "
                onClick={saveBook}
              >
                Add
              </button>
