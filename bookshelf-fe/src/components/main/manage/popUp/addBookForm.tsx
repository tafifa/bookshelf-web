...
const AddBookForm: React.FC<AddFormProps> = ({seen, onClose}) => {
  return (
    <div>
        {seen && 
        <div className='w-[346px] h-[467px] absolute flex flex-col left-2 bg-white border-custom-grey-light border-[3px] rounded-[7px] text-left'>
            <div className='mt-2 mb-2 ml-3 text-2xl font-semibold'>List Books</div>

            <div className='ml-3 mb-2 w-[310px] h-[355px] bg-[#D9D9D9] border-custom-grey-light border-[1px] rounded-[10px]'>
              <div className='ml-3 mt-3 text-xs/4 font-semibold text-[#4C4C4C]'>Book Title</div>
              ...
              <div id='flex untuk book author and book year' className='flex flex-row ml-3 justify-between'>
                <div className='flex flex-col'>
                  <div className='mt-2 text-xs/4 font-semibold text-[#4C4C4C]'>Book Author</div>
                ...
                <div className='flex flex-col mr-2'>
                  <div className='mt-2 text-xs/4 font-semibold text-[#4C4C4C]'>Book Year</div>
              ...
              <div id='flex untuk book tags and book image' className='flex flex-row ml-3 justify-between mt-2'>
                ...
                <div className='flex flex-col mr-2'>
                  <div className=' text-xs/4 font-semibold text-[#4C4C4C]'>Book Image</div>
                  <div className='mr-2 w-[136px] h-[30px] rounded-[10px] border border-custom-grey-light bg-white'>
                    <input className='ml-2 outline-none bg-transparent' type="text" />
                  </div>
                </div>
              ...
              <div className='ml-3 mt-2 text-xs/4 font-semibold text-[#4C4C4C]'>Book Description</div>
              ...
              <div className='w-[133px] h-[30px] rounded-[10px] border border-custom-grey-light bg-white flex flex-row'>
